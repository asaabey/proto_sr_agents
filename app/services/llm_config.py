...
def get_default_models() -> Dict[str, ModelConfig]:
    ...
    return {
        # OpenRouter Models (Recommended - Access to multiple providers)
        ...
        # Direct Provider Access (Alternative options)
        "gpt-4o-mini": ModelConfig(
            ...
            temperature=0.1,
            cost_per_1k_tokens=0.0001,
            recommended_use="direct OpenAI access"
        ),
        "claude-3-haiku": ModelConfig(
            ...
            recommended_use="direct Anthropic access"
        ),
...
class LLMEnvironment:
    ...
    def get_api_key(self, provider: str) -> Optional[str]:
        ...
        key_mappings = {
            "openai": ["OPENAI_API_KEY", "AZURE_OPENAI_KEY"],
            "anthropic": ["ANTHROPIC_API_KEY", "CLAUDE_API_KEY"],
            "azure": ["AZURE_OPENAI_KEY"],
            "openrouter": ["OPENROUTER_API_KEY", "OPENROUTER_KEY"],
        }
        
        for env_var in key_mappings.get(provider, []):
    ...
    def validate_setup(self) -> Dict[str, Any]:
        ...
        for provider, info in status["providers"].items():
            if not info["api_key_available"] and provider != "ollama":
    ...
    def save_config(self):
        ...
        config_data = {
            ...
            "cost_limit_per_day": self.settings.cost_limit_per_day,
...
# OpenRouter Configuration (Recommended - Access to multiple models)
